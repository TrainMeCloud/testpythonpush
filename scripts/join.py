...
EvaluateDataQuality().process_rows(frame=Join_node1760498121808, ruleset=DEFAULT_DATA_QUALITY_RULESET, publishing_options={"dataQualityEvaluationContext": "EvaluateDataQuality_node1760497996626", "enableDataQualityResultsPublishing": True}, additional_options={"dataQualityResultsPublishing.strategy": "BEST_EFFORT", "observations.scope": "ALL"})
if (Join_node1760498121808.count() >= 1):
   Join_node1760498121808 = Join_node1760498121808.coalesce(1)
AmazonS3_node1760498493864 = glueContext.write_dynamic_frame.from_options(frame=Join_node1760498121808, connection_type="s3", format="csv", connection_options={"path": "s3://tmc27m/destinationfolder/joinfolder/", "partitionKeys": []}, transformation_ctx="AmazonS3_node1760498493864")
